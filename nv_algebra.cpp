...
void mat4::set_rotx(const nv_scalar& theta)
{
	nv_scalar cosine = cos(theta);
	nv_scalar sine = sin(theta);
...
void mat4::set_roty(const nv_scalar& theta)
{
	nv_scalar cosine = cos(theta);
	nv_scalar sine = sin(theta);
...
void mat4::set_rotz(const nv_scalar& theta)
{
	nv_scalar cosine = cos(theta);
	nv_scalar sine = sin(theta);
